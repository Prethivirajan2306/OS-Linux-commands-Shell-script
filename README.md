...
![Alt text](img/uniqfile.png)

#Using tr command

cat file23 | tr [:lower:] [:upper:]
 ## OUTPUT
![Alt text](img/trcommand.png)
cat < urllist.txt
```
www. yahoo. com
www. google. com
...
![Alt text](img/urllist.png)
 
cat urllist.txt | tr -d ' ' | tr -s '.'
## OUTPUT

![Alt text](img/urllist-1.png)
